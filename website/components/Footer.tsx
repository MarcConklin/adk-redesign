        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="footer-item">
            ...
            <ul className="space-y-2 text-gray-700 text-sm">
              ...
              <li><a href="https://renndvous.com/event/supercars-at-sunset-4th-of-july-celebration/" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors font-light">Buy Tickets</a></li>
            </ul>
          </div>
